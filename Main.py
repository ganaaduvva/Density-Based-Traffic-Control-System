...
font = ('Roboto', 20, 'bold')
title = Label(main, text='			Density Based Smart Traffic Control System',anchor=W, justify=CENTER)
title.config(bg='#FF6E31', fg='white')  
...
font1 = ('Montserrat', 14, 'bold')
upload = Button(main, text="Upload Traffic Image", command=uploadTrafficImage,  bd='8')
upload.place(x=50,y=200)
upload.config(font=font1, padx='10', relief=RIDGE, activebackground='#B2B2B2')  

pathlabel = Label(main)
pathlabel.config(bg='#E14D2A', fg='white', padx='10')  
pathlabel.config(font=font1, activebackground='#B2B2B2')           
pathlabel.place(x=50,y=260)

process = Button(main, text="Image Preprocessing Using Canny Edge Detection", command=applyCanny, bd='8')
process.place(x=50,y=320)
process.config(font=font1, padx='10', relief=RIDGE, activebackground='#B2B2B2')

count = Button(main, text="White Pixel Count", command=pixelcount, bd='8')
count.place(x=50,y=380)
count.config(font=font1, padx='10', relief=RIDGE, activebackground='#B2B2B2')

count = Button(main, text="Calculate Green Signal Time Allocation", command=timeAllocation, bd='8')
count.place(x=50,y=440)
count.config(font=font1, padx='10', relief=RIDGE, activebackground='#B2B2B2')

exitButton = Button(main, text="Exit", bd='8', command=exit)
exitButton.place(x=50,y=540)
exitButton.config(font=font1)
exitButton.config(bg='#DC0000', activebackground='#C21010', fg='white', padx='10')


main.config(bg='#243763')
main.mainloop()
